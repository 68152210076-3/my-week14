        ...
        <div class="row align-items-center justify-content-center text-center py-4 mb-5">
            <div class="col-lg-9">
                ...
                @foreach ($blogs as $item)
                    <h2>{{ $item->title }}</h2>
                    @php
                        $cleanText = trim(strip_tags($item->content));
                    @endphp
                    @if ($cleanText)
                        <p>{{ Str::limit($cleanText, 100) }}</p>
                    @elseif (str_contains($item->content, '<iframe') || str_contains($item->content, '<video'))
                        <p class="text-gold small"><i class="bi bi-play-circle me-1"></i> [บทความมีวิดีโอประกอบ]</p>
                    @endif
                ...
                <p class="hero-lead mx-auto">
                    ยินดีต้อนรับสู่ระบบจัดการบทความชั้นเลิศ สัมผัสประสบการณ์การเขียนและบริหารจัดการคอนเทนต์ในบรรยากาศ Modern
                    Luxury โทนสีทองล้ำสมัย เรียบหรู และสมบูรณ์แบบ
                </p>
        ...
        <div class="row g-4 mt-2">
            <div class="col-md-4">
                <div class="luxury-feature-card">
                    ...
                    <p class="text-secondary small leading-relaxed mb-0">
                        ออกแบบด้วยความประณีต ผสมผสานประกายสีทองอร่ามกับพื้นหลังเข้มและ Glassmorphism
                        สื่อถึงภาพลักษณ์ระดับพรีเมียม
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="luxury-feature-card">
                    ...
                    <p class="text-secondary small leading-relaxed mb-0">
                        เขียน แก้ไข เผยแพร่ หรือเปลี่ยนสถานะบทความได้อย่างราบรื่นและคล่องตัว
                        ผ่านแดชบอร์ดที่ใช้งานง่ายและทันสมัย
                    </p>
                </div>
            </div>
